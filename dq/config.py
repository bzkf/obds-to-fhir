...
class Config:
    ...
    FERNMETASTASE = "https://www.medizininformatik-initiative.de/"
    "fhir/ext/modul-onko/StructureDefinition/mii-pr-onko-fernmetastasen"
    TOD = "https://www.medizininformatik-initiative.de/"
    "fhir/ext/modul-onko/StructureDefinition/mii-pr-onko-tod"
    ALL_LEISTUNSGZUSTAND = (
        "https://www.medizininformatik-initiative.de/"
        + "fhir/ext/modul-onko/CodeSystem/mii-cs-onko-allgemeiner-leistungszustand-ecog"
    )
    ...
    PRIMAERDIAGNOSE = "https://www.medizininformatik-initiative.de/"
    "fhir/ext/modul-onko/StructureDefinition/mii-pr-onko-diagnose-primaertumor"
    OP = "https://www.medizininformatik-initiative.de/"
    "fhir/ext/modul-onko/StructureDefinition/mii-pr-onko-operation"
