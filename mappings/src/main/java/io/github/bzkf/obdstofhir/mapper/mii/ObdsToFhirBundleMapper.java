...
public class ObdsToFhirBundleMapper extends ObdsToFhirMapper {
  ...
  @Value("${fhir.mappings.skip-patient-if-it-does-not-already-exist:false}")
  private boolean skipPatientIfItDoesNotAlreadyExist;
