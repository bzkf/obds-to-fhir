...
snapshots_dir = (
    HERE / "../../test/java/snapshots/org/miracum/streams/ume/obdstofhir/mapper/mii/"
).as_posix()
...
conditions = data.extract(
    ...
    columns=[
        ...
        exp("subject_reference", "subject.reference"),
    ],
)

# TODO: replace result with "patient"
conditions.join(
    result,
    conditions["subject_reference"] == concat(lit("Patient/"), result["id"]),
    how="left_anti",
)
