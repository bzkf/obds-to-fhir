...
public class GleasonScoreToObservationMapper extends ObdsToFhirMapper {
  ...
  public Observation map(Modul_Prostata modulProstata, String patientId, String opId) {
    ...
    gleasonScoreObservation.setSubject(
        new Reference()
            .setReference(
                ResourceType.Patient + "/" + this.getHash(ResourceType.Patient, patientId))
            .setIdentifier(
                new Identifier()
