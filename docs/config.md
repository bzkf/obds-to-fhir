...
| fhir.mappings.full-url-base | string | `"https://bzkf.github.io/obds-to-fhir/fhir/"` | Base URL prepended to each Bundle.entry.fullUrl, e.g. `Patient/xyz` becomes `<full-url-base>Patient/xyz`. |
