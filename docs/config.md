...
| spring.cloud.function.definition | string | `"getMeldungExportObdsV3Processor;getPatientTodObservationProcessor;getPatientVitalStatusProcessor"` |  |
...
| spring.cloud.stream.kafka.streams.bindings.getPatientTodObservationProcessor-out-0.producer.configuration."compression.type" | string | `"${KAFKA_COMPRESSION_TYPE:zstd}"` |  |
